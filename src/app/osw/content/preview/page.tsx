...
const sampleData: OswPageData = {
  ...
  faqs: [
    ...
    { question: "Do I need a GP referral to see the OSWA team?", answer: "A GP referral is not strictly required for your first appointment, but it is strongly recommended because it enables Medicare rebates to apply to your consultation fees. It also helps the OSWA team understand your medical background before your first appointment." },
  ],
