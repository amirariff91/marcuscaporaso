...
const sampleData: OswPageData = {
  ...
  eligibilityNotes: [
    ...
    "BMI 27-30, may be suitable for a medical weight management consultation at OSWA",
  ...
  howItWorksSteps: [
    { title: "GP Referral", description: "Most patients start with a referral from their GP to the OSWA team. You can also self-refer by calling (08) 9332 0066. A referral lets Medicare contribute to your consultation costs." },
  ...
  faqs: [
    ...
    { question: "How much does gastric sleeve surgery cost in Perth?", answer: "The total cost varies depending on your private health insurance level, your fund's waiting periods, and individual surgical factors. The OSWA team provides a detailed cost breakdown before any procedure. Medicare rebates apply to consultation and surgical fees. Visit our cost guide page for a full overview of what to expect." },
    { question: "Will I lose all my excess weight after sleeve surgery?", answer: "Clinical data shows patients lose an average of 60-70% of their excess weight. Individual results depend on many factors including starting weight, dietary adherence, activity levels, and whether underlying conditions like PCOS or thyroid issues are managed. Your OSWA team will discuss realistic expectations at your consultation." },
    ...
    { question: "Do I need a GP referral to see the OSWA team?", answer: "A GP referral is not strictly required for your first appointment, but it is strongly recommended because it gives you the higher referred Medicare rebate on your consultation fees; without one a lower rebate still applies. It also helps the OSWA team understand your medical background before your first appointment." },
  ],
