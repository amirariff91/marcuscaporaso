...
const pageData: OswPageData = {
  ...
  metaDescription:
    "How Medicare and private health insurance work for weight loss surgery in Australia. Item numbers, waiting periods, rebates and the OSW financial navigator.",
  heroHeadline: "Medicare and private health cover for weight loss surgery, explained plainly",
  heroSubheadline:
  ...
  stats: [
    { label: "Medicare rebate", value: "Yes", note: "Applies to eligible surgical, anaesthetic and consultation item numbers" },
  ...
  whatIsParagraphs: [
    "Funding weight loss surgery in Australia usually involves two separate systems working side by side: Medicare and your private health insurance. Medicare pays a set rebate toward eligible medical services, including the surgical item numbers commonly used for bariatric procedures, such as 30511, 30514, 30512 and 30513, as well as the anaesthetist, physician and dietitian consultations attached to your care. Medicare does not, however, pay for your hospital stay, theatre fees or accommodation.",
    "That hospital side is where private health insurance comes in. To have your hospital and theatre costs covered, you generally need a gold tier policy, or an equivalent level that specifically includes bariatric or weight loss surgery and lists the relevant item numbers, including 30511 and 30514 among others. Not every gold policy includes bariatric surgery, and not every fund treats it the same way, which is exactly why checking your individual policy matters so much.",
  ...
  eligibilityNotes: [
    "Medicare rebates apply to eligible surgical item numbers (30511, 30514, 30512, 30513) plus the anaesthetist, physician and dietitian consultations connected to your surgery.",
    "Medicare does not cover hospital theatre fees or accommodation; that is the role of your private hospital cover.",
    "Private hospital cover generally needs to be gold tier or equivalent and must specifically include bariatric surgery item numbers such as 30511 and 30514.",
  ...
  howItWorksSteps: [
    { title: "Check Your Cover", description: "Call your fund and ask specifically about 30511 and 30514, whether bariatric surgery is included, and your waiting period status. Note any excess or copayment." },
  ...
  benefits: [
    ...
    "Confirming that your policy includes bariatric item numbers like 30511 and 30514 before you commit protects you from finding gaps too late.",
  ...
  faqs: [
    {
      ...
      answer:
        "Medicare contributes a set rebate toward eligible medical services, including the surgical item numbers commonly used for bariatric surgery, such as 30511, 30514, 30512 and 30513, and toward your anaesthetist, physician and dietitian consultations. Medicare does not pay for your hospital stay, theatre fees or accommodation, which is why private hospital cover is usually needed alongside it.",
    },
    {
      question: "What private health cover do I need for bariatric surgery?",
      answer:
        "You generally need a gold tier policy, or an equivalent level that specifically includes bariatric or weight loss surgery and lists the relevant item numbers, including 30511 and 30514 among others. Not every gold policy includes bariatric surgery, so it is important to confirm the specific item numbers are covered rather than assuming your tier includes them.",
    },
    {
