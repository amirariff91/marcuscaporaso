...
const pageData: OswPageData = {
  ...
  whatIsParagraphs: [
    ...
    "This is why Obesity Surgery WA is not just a group of surgeons. Our team includes physicians who manage the medical side of weight, specialist dietitians whose nutrition support runs through your care, and exercise physiologists who support the movement side alongside them. Whoever you see first, you are stepping into a team that can move you along the spectrum of care as your needs change.",
