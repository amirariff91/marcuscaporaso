# Content Brief: Our Bariatric Surgeons
**URL:** /surgeons
...
### Hero
- **Headline direction:** Name the team and anchor it to Perth. The reader should immediately know this is a real, identifiable surgical practice, not a generic clinic.
- **Subheadline:** Warm, direct, and honest. Acknowledge that choosing a surgeon is a significant decision. Introduce the lead surgeon's FRACS credential and — briefly — the personal detail that he has undergone bariatric surgery himself. This is a differentiator, not a marketing line; write it that way. One to two sentences maximum.
...
A short, practical paragraph guiding readers who are comparing surgeons. Tell them what actually matters when assessing bariatric surgeons: FRACS fellowship, accredited hospital privileges, quality of the aftercare team, and whether the surgeon takes time to understand individual circumstances. This is genuinely useful consumer guidance, not a competitive put-down.
...
**Tone:** Calm, direct, and frank. This section builds trust precisely because it does not minimise risk. It is not a legal disclaimer — it reads as a genuine conversation.

**Opening paragraph:** State clearly that no surgeon can promise a specific result, and that patients should be cautious of anyone who does. Describe surgery as a powerful tool that works alongside the patient's effort, not instead of it.

**Risk bullet points (4 items):**
- All surgery carries risks: bleeding, infection, blood clots, anaesthetic reactions
- Some patients experience loose skin after significant weight loss; this varies between individuals and may be addressable later
- Long-term success depends on sustained dietary and lifestyle changes; weight can return without them
- Lifelong vitamin and nutrient monitoring is required after some procedures; the team supports this

### Cost paragraph
Explain that costs depend on the procedure chosen, private health cover level, and individual circumstances. Note that most bariatric procedures attract a Medicare item number and that patients with appropriate private hospital cover typically pay a gap rather than the full fee. Mention that early superannuation access is an option some patients use. Emphasise that a written, itemised estimate is provided before any commitment is made — no surprises. Do not quote specific dollar figures on this page.
...
Direction: Warm, low-pressure, action-oriented. Should invite the reader to take the first step — meet the team and have a conversation — without implying obligation. Something in the spirit of: "Ready to meet the team and talk through your options without any pressure?"

### FAQs
The page should answer all of the following questions. Write each answer in plain, direct language — no jargon, no hedging beyond what compliance requires.

1. What makes a good bariatric surgeon in Perth? (FRACS, hospital accreditation, aftercare team, time taken with patients)
...
- Both surgeons must be identified with their full credentials (MBBS, FRACS) in every bio reference
...
- Do not claim to be "the best" or "Perth's leading" — all comparative claims require substantiation
- All surgery risk information must be present and must not be minimised or buried
- Medicare item numbers may be mentioned factually (they are publicly available MBS information) but eligibility must be described as clinically assessed, not assumed
- Bariatric Surgery Registry can be mentioned as a quality indicator (it is publicly known information)
- Voice: direct, credible, honest — this is a clinical practice, not a wellness brand
