# Content Brief: Weight Loss Surgery Cost Perth
...
### Hero
- **Headline direction:** Acknowledge the reader's frustration upfront — cost is what everyone wants to know and what's hardest to get a straight answer on. Name this tension directly. The headline should signal that this page will actually answer the question.
- **Subheadline:** Commit to laying out real numbers, explaining what shapes them, and showing how Medicare, private health and super fit in. State clearly that a written estimate specific to the individual will be provided when they're ready. Tone: plain-spoken and reassuring, not promotional.

### Stats bar (4 stats)
These anchors give the reader orientation before they read the detail. Write them as factual planning figures:
1. **Gastric sleeve / $12k–$20k** — approximate out-of-pocket range; note it varies with insurance cover
2. **Gastric bypass / $15k–$25k** — approximate out-of-pocket range; note it varies with insurance cover
3. **Insurance wait / 12 months** — typical waiting period for obesity surgery cover with most funds (note this is standard across funds, not unique to the practice)
4. **Your estimate / Written** — a personalised quote provided before any commitment

Flag clearly that these are planning ranges, not quotes.

### How weight loss surgery costs are built (4 paragraphs)

**Paragraph 1 — No sticker price**
Explain that there is no single price and that anyone quoting one figure without knowing the individual's situation is guessing. The total is made up of several separate fees, and how much of each is covered depends on private health insurance, Medicare entitlement and the procedure chosen.

**Paragraph 2 — The fee components**
Name all the components: surgeon's fee, anaesthetist's fee, assistant surgeon's fee (where applicable), and the hospital fee. Note that there can also be costs for the dietitian, follow-up appointments and pre-operative tests. Each is billed separately — this is why the headline number can feel confusing.

**Paragraph 3 — Approximate ranges by procedure**
Provide the approximate planning figures: gastric sleeve typically $12,000–$20,000 out of pocket; gastric bypass typically $15,000–$25,000; gastric banding generally at the lower end. State clearly that these are approximate ranges to help with planning, not quotes — the figure that matters is the personalised estimate the practice prepares.

**Paragraph 4 — The biggest single cost factor**
Explain that the biggest determinant of what the patient actually pays is whether they have appropriate private health insurance and whether the waiting period has been served. With the right cover, the hospital fee is largely covered and out-of-pocket drops considerably. Without it, the hospital component becomes a significant self-funded cost.

### Comparison note (inline callout)
Short, honest note: every range on this page uses "approximately" or "around" deliberately. Costs move with the procedure, the surgeon's assessment, the insurer's policy and the hospital. The practice does not ask patients to make decisions on a ballpark — a written estimate comes first.
...
- **Superannuation:** May be accessible on compassionate grounds where obesity is causing a serious medical condition. Assessed case by case by the regulator — not automatic.
- **When cost is the barrier:** Encourage early conversation with the team — there are often more options than patients expect once they sit down with the numbers.

### How it works (5 steps)
These steps cover both the clinical and financial pathway — the cost story runs through each one.

1. **Initial consultation and clinical assessment** — Surgeon assesses whether surgery is appropriate and which procedure suits the patient; the procedure recommended shapes the cost, so this comes first; consultation attracts a Medicare rebate for eligible patients
2. **Private health cover check** — The team helps confirm whether the patient's policy covers the relevant item numbers (31575, 31572) and whether the 12-month waiting period has been served; this is where the largest cost question is answered
3. **Written, itemised estimate** — Before any commitment, a personalised estimate lists the surgeon, anaesthetist, assistant and hospital fees, what the insurer is expected to cover, and the likely out-of-pocket; no surprises is the practice standard
4. **Funding options discussion** — If there is a gap, the team walks through how Medicare rebates, early super access on compassionate grounds, and third-party payment plans might apply
5. **Decision with full visibility** — Patient proceeds only once every number on the page is understood; this should never feel rushed

### What a clear cost estimate gives you (benefits)
Write as a bulleted list, six points. Frame benefits around the value of transparency and informed decision-making, not clinical outcomes.
- A written breakdown of every fee, so each line has a name and a reason rather than one intimidating total
- Clarity on what the private health fund is expected to cover, checked against the patient's specific policy and item numbers
- An understanding of the Medicare rebate on surgical and consultation fees — and where it does and does not apply
- Honest guidance on whether waiting to serve an insurance waiting period could save a substantial amount
- Information on super access on compassionate grounds and payment plans, so every funding route can be weighed
- The confidence to make a decision on the patient's own terms, without pressure and without hidden costs appearing later

### Cost factors and common pitfalls (risks section)
**Tone:** Matter-of-fact and genuinely helpful. Most cost surprises come from gaps in understanding, not from the surgery itself. Frame this as consumer education.

**Opening paragraph:** State that most cost surprises in bariatric surgery arise from misunderstandings rather than from the surgery itself. Knowing these in advance helps avoid them. The practice raises them openly because the alternative is an unwelcome bill after the fact.

**Pitfall bullet points (6 items):**
- Assuming all private health policies cover obesity surgery — many do not; some cover consultations but not the hospital item numbers; always check 31575 and 31572 specifically
- Overlooking the 12-month waiting period — booking before it is served can mean the entire hospital fee falls on the patient
...
- Not budgeting for separate anaesthetist and assistant surgeon fees, which are billed independently
...
- Treating a verbal ballpark as a quote — the only figure to plan around is the written, itemised estimate

### Cost paragraph
This is the financial centrepiece of the page. Write it as an honest, comprehensive summary:
- With appropriate private health cover and waiting period served: out-of-pocket for a gastric sleeve **typically around $12,000–$20,000**; gastric bypass **around $15,000–$25,000**; banding generally lower
- Without suitable cover: the hospital fee adds significantly to the total
- Medicare rebates reduce the surgical and consultation portion for eligible patients but do not cover the hospital admission
- Some providers offer payment plans to spread the out-of-pocket cost
- Super may be accessible on compassionate grounds where obesity is causing a serious medical condition — assessed individually, not automatic
- None of this needs to be worked out by the patient alone — the team prepares a written estimate so the patient sees the real numbers before deciding anything

Repeat clearly: these are approximate planning ranges. The personalised written estimate is the figure to plan around.
...
Do not quote average weight loss percentages on this page — this is a cost page, not a clinical outcomes page.

### Conversion CTA headline
Direction: Specific to this page's value — getting a personalised estimate. Direct and action-oriented without pressure. Something in the spirit of: "Get a written cost estimate specific to you, before you decide anything."

### FAQs
Write each answer in plain, direct language. Readers here may not have chosen a procedure yet, so answers should be appropriately broad while still being specific enough to be useful.
...
7. How do I get an estimate specific to my situation? (Book consultation; surgeon assesses appropriate procedure; team checks health cover and Medicare eligibility; written itemised estimate produced showing every fee and likely out-of-pocket before commitment)

---

## Tone and compliance notes
- All price ranges are approximate planning guides only — never present as quotes; always refer to the written estimate as the authoritative figure
- MBS item numbers 31575 (sleeve) and 31572 (bypass) may be mentioned as publicly available MBS information; always describe eligibility as clinically assessed
- Medicare's non-coverage of hospital admissions must be stated clearly — a common misunderstanding among patients
- Super access: describe accurately as a possibility that is individually assessed; do not imply it is easy or automatic
- No outcome promises — weight loss results must include explicit variance caveat if mentioned at all
- AHPRA/TGA compliance: no testimonials, no before/after framing, no comparative claims without substantiation
- Both surgeon bios must include FRACS credentials
- Voice: plain-spoken, honest, and practical — this is an anxious reader who deserves clarity, not marketing language
