# Content Brief: Am I Eligible for Weight Loss Surgery?
**URL:** /am-i-eligible
...
### Hero
- Headline direction: Echo the reader's own question back to them — direct and non-clinical. It should feel like the page heard them.
- Subheadline: 2–3 sentences that acknowledge the emotional reality (years of trying, not a willpower problem), signal that this page will give them real answers, and make explicit there is no obligation or pressure in getting an answer.
...
- Intro paragraph: Set a tone of respect for the reader's intelligence. Acknowledge that being eligible does not automatically make surgery the right choice; part of the assessment is making sure the patient understands both the commitment and the risks so they can decide clearly.
- Risk bullets to address (one sentence each, plain language):
...
2. I have tried every diet and they all failed. Does that count against me?
